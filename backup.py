...
@prefix.command()
async def nlearn(ctx):
    await ctx.send('https://nlearn.nspira.in/')


@prefix.command()
async def chalam_sirs_channel(ctx):
...
async def truth(ctx):
    questions_for_truth = [
        ...
        "Who is the one person you hate most in the world?", "What do you do when you are alone at home?",
...
async def _8ball(ctx, *, question):
    responses = ["It is certain.", "It is decidedly so.", "Without a doubt.", "Yes -         definitely.",
                 ...
                 "Very doubtful.""No... I mean yes... Well... Ask again later",
